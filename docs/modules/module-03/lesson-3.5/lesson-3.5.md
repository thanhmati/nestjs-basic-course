...
> [!IMPORTANT]
> **Câu hỏi kiến trúc cốt lõi:** _"Tại sao ở Lesson 3.3 chúng ta đã viết `LoggerMiddleware`, sang Lesson 3.5 lại viết thêm `LoggingInterceptor`? Chúng giải quyết bài toán gì ở các tầng khác nhau?"_

### 📊 Bảng So Sánh Chi Tiết Giữa 2 Tầng Logging

| Tiêu chí                                       | `LoggerMiddleware` (Lesson 3.3)                                                                                                                                        | `LoggingInterceptor` (Lesson 3.5)                                                                                                                                             |
| :--------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
Để linh hoạt tùy chỉnh thông báo hoặc bỏ qua việc bọc data (đối với các API xuất file Excel/PDF, SSE stream), chúng ta tạo 2 Decorator chuyên dụng:
