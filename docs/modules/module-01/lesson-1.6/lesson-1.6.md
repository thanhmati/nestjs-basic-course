...
👉 **Bài tiếp theo:** [Lesson 1.7: Tự Động Format & Lint Với Lint-Staged](../lesson-1.7/lesson-1.7.md) _(chỉ lint những file thực sự thay đổi thay vì quét toàn bộ project)_.
